...
استفاده از این پکیج در محیط production <span class="underline">می‌تواند</span> خطرناک باشد و باعث نشت اطلاعات مهم محصول شما شود؛ لطفا در صورتی که تصمیم دارید از این پکیج در محیط production استفاده کنید، از خاموش بودن APP_DEBUG مطمئن شوید.