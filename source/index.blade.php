...
@section('body')
    <div class="landing container">
        ...
        <p>از سال ۱۳۹۷ تا امروز مشغول ساخت و ساز در اینترنت بودم و هنوز هم در تلاش برای ساختن ابزارهای مفید در بستر وب هستم.
        ...
        <p>من آگاهانه تلاش می‌کنم در شبکه‌های مجازی حضور نداشته باشم و ارتباط دیجیتالم رو به چند ابزار ساده و همیشگی محدود
