...
@section('content')
    <section class="mb-3">
        <p>I am a back-end developer with {{ $page->getMyYearsOfExperience() }}+ years of professional experience in B2B, B2C,
            ...
            daily
            basis. Apart from experience in agile environments, I have mentored junior developers and led small
            teams to
            ship
    ...
    <section class="mb-3">
        ...
        <div class="mb-1">
            ...
            <ul class="ml-3 list-disc list-inside">
                ...
                <li>Led a small team of developers to create the most popular digital menu platform in the city.
                    (Over
                ...
                <li>Boosted overall performance of the product by 30% by leveraging queues, query optimization and
                    caching.</li>
                <li>Created a private CDN-like server to host static files, which improved load time by 42% and
                    reduced
        ...
        <div class="mb-1">
            ...
            <ul class="ml-3 list-disc list-inside">
                <li>Engineered a solution to auto-update frequently changed data without the need of a human
                    operator,
    ...
    <section class="my-10">
        <div class="flex flex-col md:flex-row  gap-3">
            ...
            <a class="flex-1 bg-primary-500 text-white py-3 px-6 block text-center cursor-pointer"
                href="mail:hesamrad.dev@gmail.com">
